...
public class ListOfDatum implements Parcelable
{
    ...
    @Expose
    private List<ListOfDatumData> listOfData = null;
    ...
    public List<ListOfDatumData> getListOfData() {
        return listOfData;
    }

    public void setListOfData(List<ListOfDatumData> listOfData) {
    ...
    protected ListOfDatum(Parcel in) {
        ...
        this.listOfData = in.createTypedArrayList(ListOfDatumData.CREATOR);
    }
