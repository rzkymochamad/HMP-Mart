...
public class OnBoardObject implements Parcelable {
    ...
    public OnBoardObject(int icon, String title, String tagline, String onboardNo) {
        this.icon = icon;
        this.title = title;
        this.tagline = tagline;
    ...
    public OnBoardObject setOnboardNo(String onboardNo) {
        this.onboardNo = onboardNo;
        return this;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.onboardNo);
    }
