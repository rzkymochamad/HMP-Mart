...
public class FeaturedProductAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static final int FEATURED_PRODUCT_VIEW = 3;
    ...
    public FeaturedProductAdapter(Context context, List<Object> dataArray) {
    ...
    public FeaturedProductAdapter(Context context, List<Object> dataArray, SelectionInterface selectionInterface) {
        this.context = context;
        this.dataArray = (ArrayList<Object>) dataArray;
    ...
    protected class FeaturedProductHolder extends RecyclerView.ViewHolder implements StrategyAdapter {
        ...
        public FeaturedProductHolder(View view) {
            super(view);
        ...
        public void executeHolderFunctionality(RecyclerView.ViewHolder holder, int position) {
            ...
            final FeaturedProductHolder productHolder = (FeaturedProductHolder) holder;
            final com.mg.shopping.jsonutil.featuredproductutil.ListOfDatum listOfDatum
                    = (com.mg.shopping.jsonutil.featuredproductutil.ListOfDatum) dataArray.get(position);
